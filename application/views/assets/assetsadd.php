         ...
         <div class="row">
             ...
             <div class="col-md-12">
                 ...
                 <div class="box box-primary">
                     ...
                     <!-- form start -->
                     <form role="form" data-toggle="validator" action="<?= site_url()?>assets/assetsaddpro/" method="post">
                         <div class="box-body">
                            <div class="col-md-12">
                                 <div class="form-group has-feedback col-md-6 col-sm-6 col-xs-6 col-sm-offset-3">
                                     ...
                                     <input type="text" name="asset_amount" class="form-control" maxlength="50" minlength="1" id="exampleInputEmail1"  required/>
