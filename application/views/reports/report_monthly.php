         ...
         <div class="row">
             ...
             <div class="col-md-12">
                 ...
                 <div class="box box-primary">
                     ...
                     <!-- form start -->
                     <form role="form" data-toggle="validator" action="<?= site_url()?>reports/reports_monthly_pro/" method="post">
                         <div class="box-body">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                 <div class="form-group has-feedback col-sm-6 col-sm-offset-3">
                                     ...
                                     <input type="date" name="to_date" class="form-control" maxlength="50" minlength="3" id="exampleInputEmail1"  required/>
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                            </div>
