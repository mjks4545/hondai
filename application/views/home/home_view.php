          ...
          <div class="row" style="margin-top:20px;">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="<?=site_url()?>member/" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                ...
                <a href="<?=base_url()?>assets/assets_home" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-3 col-xs-6">
              <div class="small-box bg-green">
